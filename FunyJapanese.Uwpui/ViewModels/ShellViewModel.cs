...
namespace FunyJapanese.Uwpui.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_Page1".GetLocalized(), Symbol.Document, typeof(Page1ViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_WebViewTemplate".GetLocalized(), Symbol.Document, typeof(WebViewTemplateViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_Template".GetLocalized(), Symbol.Document, typeof(TemplateViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_MainPage".GetLocalized(), Symbol.Document, typeof(MainPageViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_GridTempalte".GetLocalized(), Symbol.Document, typeof(GridTempalteViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_ChartTempalte".GetLocalized(), Symbol.Document, typeof(ChartTempalteViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_TabbedTemplate".GetLocalized(), Symbol.Document, typeof(TabbedTemplateViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_ImageGalleryTemplagte".GetLocalized(), Symbol.Document, typeof(ImageGalleryTemplagteViewModel).FullName));
